...
export interface ColorProps<T> {
  bg?: ResponsiveStyleValue<T & StandardCSSProperties['backgroundColor']>;
  background?: ResponsiveStyleValue<T & StandardCSSProperties['background']>;
  color?: ResponsiveStyleValue<T & StandardCSSProperties['color']>;
  borderColor?: ResponsiveStyleValue<T & StandardCSSProperties['borderColor']>;
  borderBottomColor?: ResponsiveStyleValue<T & StandardCSSProperties['borderBottomColor']>;
  borderTopColor?: ResponsiveStyleValue<T & StandardCSSProperties['borderTopColor']>;
  borderLeftColor?: ResponsiveStyleValue<T & StandardCSSProperties['borderLeftColor']>;
  borderRightColor?: ResponsiveStyleValue<T & StandardCSSProperties['borderRightColor']>;
}

export interface SpaceProps<T> {
  margin?: ResponsiveStyleValue<T & StandardCSSProperties['margin']>;
  m?: ResponsiveStyleValue<T & StandardCSSProperties['margin']>;
  mt?: ResponsiveStyleValue<T & StandardCSSProperties['marginTop']>;
  mr?: ResponsiveStyleValue<T & StandardCSSProperties['marginRight']>;
  mb?: ResponsiveStyleValue<T & StandardCSSProperties['marginBottom']>;
  ml?: ResponsiveStyleValue<T & StandardCSSProperties['marginLeft']>;
  mx?: ResponsiveStyleValue<T & StandardCSSProperties['marginLeft']>;
  marginX?: ResponsiveStyleValue<T & StandardCSSProperties['marginLeft']>;
  my?: ResponsiveStyleValue<T & StandardCSSProperties['marginTop']>;
  marginY?: ResponsiveStyleValue<T & StandardCSSProperties['marginTop']>;
  padding?: ResponsiveStyleValue<T & StandardCSSProperties['padding']>;
  p?: ResponsiveStyleValue<T & StandardCSSProperties['padding']>;
  pt?: ResponsiveStyleValue<T & StandardCSSProperties['paddingTop']>;
  pr?: ResponsiveStyleValue<T & StandardCSSProperties['paddingRight']>;
  pb?: ResponsiveStyleValue<T & StandardCSSProperties['paddingBottom']>;
  pl?: ResponsiveStyleValue<T & StandardCSSProperties['paddingLeft']>;
  px?: ResponsiveStyleValue<T & StandardCSSProperties['paddingLeft']>;
  paddingX?: ResponsiveStyleValue<T & StandardCSSProperties['paddingLeft']>;
  py?: ResponsiveStyleValue<T & StandardCSSProperties['paddingTop']>;
  paddingY?: ResponsiveStyleValue<T & StandardCSSProperties['paddingTop']>;
  size?: ResponsiveStyleValue<T & StandardCSSProperties['width']>;
}
export interface TextStyleProp<T> {
  textStyle?: ResponsiveStyleValue<T>;
}
